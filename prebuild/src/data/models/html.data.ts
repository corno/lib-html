...
export const $: g_liana.T.Type__Library<pd.SourceLocation> = {
    ...
    'global types': d({
        ...
        */
        ...
        "Flow": globalType({}, taggedUnion({
            //generic attributes
            "id": option(group({
                "id": prop(terminal("tbd")),
                "child": prop(component("Flow", {}))
            })),
            "class": option(group({
            ...
            */
            "script supporting": option(component("Script supporting", {})),
            ...
            "details": option(group({
                "summary": prop(array(taggedUnion({
                    ...
                    "heading": option(component("Heading", {})),
                }))),
        ...
        "Flow content": globalType({}, array(taggedUnion({
            ...
            "flow": option(component("Flow", {})),
        }))),
        "Heading": globalType({}, taggedUnion({
        ...
        "Script supporting": globalType({}, taggedUnion({
            "script": option(group({
                /*FIXME*/
                // src — Address of the resource
                // type — Type of script
