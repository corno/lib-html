...
export declare namespace T {
    ...
    namespace Global__Type__Selection {
        ...
        namespace _limport {
            ...
            namespace _ltype {
                type key = string;
                namespace referent {
                    type O = T.Type__Library.global__types.D;
                }
                type referent = [false] | [true, T.Type__Library.global__types.D];
            }
            type _ltype = {
                readonly 'key': string;
    ...
    namespace Type__Selection__Tail {
        namespace step__type {
            namespace array {
                namespace array {
                    type O = T.Type._ltype.array;
                }
                type array = [false] | [true, T.Type._ltype.array];
            }
            type array = {
            ...
            namespace optional {
                namespace optional {
                    type O = T.Type._ltype.optional;
                }
                type optional = [false] | [true, T.Type._ltype.optional];
            }
            type optional = {
