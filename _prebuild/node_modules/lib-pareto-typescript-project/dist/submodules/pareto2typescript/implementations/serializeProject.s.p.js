...
const $$ = ($d) => {
    return ($, $i) => {
        ...
        function generateTemplates($p, $i, $c) {
        ...
        function serializeAlgorithmTypeReference($, $i) {
                    ...
                    switch ($.type[0]) {
                        ...
                        case 'resource':
                            pl.ss($.type, ($) => {
                                ...
                                generateTemplates($.definition.api.root, $i, {
                                    'extension': ($) => `native`
                                });
                                generateAPI($.definition.api.root, $i, {
                                    'extension': ($) => `native`
                                });
